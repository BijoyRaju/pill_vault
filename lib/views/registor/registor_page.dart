    ...
    return Scaffold(
      body: ListView(
        children: [
          ...
          SizedBox(height: 20),
          Center(child: Text("Registration", style: TextStyle(fontSize: 24))),
          Padding(
                  ...
                  onPressed: () async {
                    ...
                    if (name.isEmpty ||
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text(TextConstants.scafolfMsg)),
                      );
                      return;
                    }
                    ...
                    if (exists) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(TextConstants.emailExistMsg),
                        ),
                      );
                      return;
                    }
